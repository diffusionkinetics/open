                 ...
                 div_ [class_ "col-md-6"] $ pre_ $ code_ $ toHtml
                  [text|
                   ...
                   in plotly "div3" 
                             ...
                             & layout . height ?~ 300  |]
                 div_ [class_ "col-md-6"] $ toHtml $ plotly "div3" [myTrace & mode ?~ [Markers]] & layout . margin ?~ thinMargins
                                                                           & layout . height ?~ 300                              
               row_ $ do
                 div_ [class_ "col-md-6"] $ pre_ $ code_ $ toHtml
                  [text|
                   ...
                   in plotly "div4" 
                             ...
                             & layout . margin ?~ thinMargins
                             & layout . height ?~ 300  |]
                 div_ [class_ "col-md-6"] $ toHtml $ plotly "div4" [myTrace & mode ?~ [Lines]] & layout . margin ?~ thinMargins
                                                                           & layout . height ?~ 300                              
               row_ $ do
                 div_ [class_ "col-md-6"] $ pre_ $ code_ $ toHtml
                  [text|
                   ...
                   in plotly "div5" 
                             ...
                             & layout . margin ?~ thinMargins
                             & layout . height ?~ 300  |]
                 div_ [class_ "col-md-6"] $ toHtml $ plotly "div5" [myTrace & mode ?~ [Lines,Markers]] & layout . margin ?~ thinMargins
                                                                           & layout . height ?~ 300                              
